                            ...
                            <form id="myForm" method="post" action="{{ route('update.blogs') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <img src="{{ !empty($edit_blog->main_image) ? asset($edit_blog->main_image) : url('upload/no_image.jpg') }}"
                                            alt="" id="main_image_show" class="avatar-lg img-thumbnail"
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <img src="{{ !empty($edit_blog->banner_image) ? asset($edit_blog->banner_image) : url('upload/no_image.jpg') }}"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="file" id="details_image1" name="details_image1"
                                                class="form-control">
                                        </div>
                                        <img src="{{ !empty($edit_blog->details_image1) ? asset($edit_blog->details_image1) : url('upload/no_image.jpg') }}"
                                            alt="" id="details_image1_show" class="avatar-lg img-thumbnail"
                                            alt="profile-image" style="width: 120px;height:120px">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="file" id="details_image2" name="details_image2"
                                                class="form-control">
                                        </div>
                                        <img src="{{ !empty($edit_blog->details_image2) ? asset($edit_blog->details_image2) : url('upload/no_image.jpg') }}"
                                            alt="" id="details_image2_show" class="avatar-lg img-thumbnail"
                                            alt="profile-image" style="width: 120px;height:120px">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="file" id="details_image3" name="details_image3"
                                                class="form-control">
                                        </div>
                                        <img src="{{ !empty($edit_blog->details_image3) ? asset($edit_blog->details_image3) : url('upload/no_image.jpg') }}"
                                            alt="" id="details_image3_show" class="avatar-lg img-thumbnail"
                                            alt="profile-image" style="width: 120px;height:120px">
