                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="myForm" method="post" action="{{ route('blogs.store') }}"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <img src="{{ url('upload/no_image.jpg') }}" alt=""
                                            id="details_image1_show" class="avatar-lg img-thumbnail" alt="profile-image"
                                            style="width: 120px;height:120px">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <img src="{{ url('upload/no_image.jpg') }}" alt=""
                                            id="details_image2_show" class="avatar-lg img-thumbnail" alt="profile-image"
                                            style="width: 120px;height:120px">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <img src="{{ url('upload/no_image.jpg') }}" alt=""
                                            id="details_image3_show" class="avatar-lg img-thumbnail" alt="profile-image"
                                            style="width: 120px;height:120px">
