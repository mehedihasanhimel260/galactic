                            ...
                            <ol class="breadcrumb m-0">
                                <a href="{{ route('all.video') }}"
                                    class="btn btn-primary rounded-pill waves-effect waves-light"><i
                                        class="fe-arrow-left"></i>All Videos</a>
                            </ol>
                        </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="myForm" method="post" action="{{ route('video.update') }}"
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group mb-3">
                                        <label for="video_link" class="form-label">Video Title </label>
                                        <input type="text" class="form-control" value="{{ $edit_video->title }}"
                                            name="title">
                                    </div>
                                </div>
